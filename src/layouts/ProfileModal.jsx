  ...
  return (
    <div>
      <button
        ...
        className="block text-white bg-cyan-700 hover:bg-slate-400 hover:text-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        type="button"
      >
        Add Profile
      </button>
