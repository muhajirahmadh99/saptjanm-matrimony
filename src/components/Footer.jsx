          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-black sm:mb-0">
              <li>
                <Link
                  to={"/about"}
                  className="no-underline text-black me-4 md:me-6 hover:underline"
                >
                  About
                </Link>
              </li>
              <li>
                <Link className="no-underline text-black me-4 md:me-6 hover:underline">
                  Privacy Policy
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to={"/contact"} className="no-underline text-black hover:underline">
                  Contact
                </Link>
              </li>
            </ul>
